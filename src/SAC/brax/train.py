...
from plots import make_plot, make_plots
...
def progress(num_steps, metrics):
    ...
    metrics_history["reward"].append(metrics["eval/episode_reward"])
    metrics_history["forward"].append(metrics["eval/episode_forward_reward"])
    metrics_history["velocity"].append(metrics["eval/episode_x_velocity"])
    metrics_history["alpha"].append(metrics.get("training/alpha_loss"))
    metrics_history["critic_loss"].append(metrics.get("training/critic_loss"))
    metrics_history["actor_loss"].append(metrics.get("training/actor_loss"))
    metrics_history["reward_std"].append(metrics["eval/episode_reward_std"])
...
make_plots(env_name, xdata, metrics_history)
