...
'ant': functools.partial(ppo_train,  num_timesteps=50_000_000, num_evals=10, reward_scaling=10, episode_length=1000, normalize_observations=True, action_repeat=1, unroll_length=5, num_minibatches=32, num_updates_per_batch=4, discounting=0.97, learning_rate=3e-4, entropy_cost=1e-2, num_envs=4096, batch_size=2048, seed=1, save_checkpoint_path=f"reports/checkpoints/{env_name}"),
...
model.save_params(f"reports/params/{env_name}_param", params)
